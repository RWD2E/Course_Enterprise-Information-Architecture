...
Take a look at the following decompositional view of "a pad of paper" as an example. In this simple 1-level system, the **elements** are: paper sheets, covers, and spiral.

![Figure 1. Decompositional View of a Pad of Paper](img/pad_of_paper.png)
...
: Table 1. Basic Schematic Components
...
-   Graphical representation: **Object-Process Modeling (OPM)**

![Figure 2. Basic Schematic of OPM](img/opm_schematic.png){width="870"}
...
+-------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ![](img/opm_enabler.png){width="109"}           | is a special type of operand that enable a particular process                                                                                                                                        |
+-------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ![](img/opm_link1.png){width="211" height="40"} |                                                                                                                                                                                                      |
+-------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ![](img/opm_link2.png)                          |                                                                                                                                                                                                      |
+-------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                                                 |                                                                                                                                                                                                      |
...
-   List representation: **Design Structure Matrix (DSM)** is a "N-squared" matrix representation gives list-like representation of connectivity. DSM can be used to map relationships among different elements/operands/forms, functions, and relationships between forms and functions.

![Figure 3. And example of DSM](img/dsm_sample.png)
...
![Figure 2. Form-Function Sequence](img/form_function.png){width="1017"}
