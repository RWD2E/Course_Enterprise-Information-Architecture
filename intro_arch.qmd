...
|                                                                                                                                               |                                                                                                                                        |
| -   The actions for which a thing exists or is employed                                                                                       | -   Must be conceived so that goalscan be achieved                                                                                     |
|                                                                                                                                               |                                                                                                                                        |
| -   Is a product/system attribute                                                                                                             | -   Is what the system eventually does, the activities and transformations which emergeas sub-function aggregate (i.e., **Emergence**) |
|                                                                                                                                               |                                                                                                                                        |
| -   **System** defined as: "A set of interrelated elements that perform a function, whose functionality is greater than the sum of the parts" | -   Should initially be stated in solution neutral language                                                                            |
+-----------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------+
...
-   List representation: **Design Structure Matrix (DSM)**
...
![Figure 3. Architectural Decision Matrix](img/arch_decision_matrix)
