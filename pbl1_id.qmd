...
-   Architecture Diagram. There are many free or open-source tools for diagramming, such as Lucidchart (<https://www.lucidchart.com/pages>), Diagrams.net (previously draw.io, <https://app.diagrams.net/>), etc. You may use whichever tool you are most comfortable with or that best fits your needs. For classroom demonstrations, I will be using Lucidchart.
